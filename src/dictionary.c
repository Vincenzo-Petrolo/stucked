...
//     dict = add(dict, "culo", 1);
//     dict = add(dict, "cacca", 1);
//     dict = add(dict, "culazzo", 1);
//     dict = add(dict, "animale", 1);
//     dict = add(dict, "porcodio", 1);
//     dict = add(dict, "porcodio", 1);
//     dict = add(dict, "porcodio", 1);
//     dict = add(dict, "porcodio", 1);
//     dict = add(dict, "porcodio", 1);
...
//     dict = add(dict, "porcodio", 1);
//     dict = add(dict, "dam", 1);
//     dict = add(dict, "funghi", 1);
//     dict = add(dict, "peperoni ripieni", 1);
//     dict = add(dict, "telegram", 1);
//     dict = add(dict, "computer", 1);
//     dict = add(dict, "anello", 1);
//     dict = add(dict, "loazcastoosrioo", 1);
//     dict = add(dict, "urto", 1);
//     dict = add(dict, "porto", 1);
//     dict = add(dict, "asino", 1);
//     dict = add(dict, "cavallo", 1);
//     dict = add(dict, "cavallo", 1);
//     dict = add(dict, "ootovolante", 1);
//     dict = add(dict, "jesulj", 1);
